...
void WaterWaveAction::update(float time)
{
	...
	float *oriVerArray = (float*)(((GridColor3D*)_gridNodeTarget->getGrid())->getOriginalVertex());
	float *colorArray = (float*)(((GridColor3D*)_gridNodeTarget->getGrid())->getGridColor());
...
{
    GridColor3D *g = (GridColor3D*)_gridNodeTarget->getGrid();
